...
(function ($) {
  ...
  var LiteAccordion = function (elem, options) {
    ...
    settings = $.extend({}, defaults, options),
            ...
            // public methods
            methods = {
              // Resize parent div change
              resize: function (args) {
                methods.destroy();
                settings = $.extend({}, settings, args[1]);
                elem.liteAccordion(settings);
              },
              ...
              jumpto: function (i) {
                methods.stop();
                header.eq(0).trigger('click.liteAccordion');
              },
    ...
    core = {
      ...
      init: function () {
        ...
        if (settings.cycleSpeed < settings.slideSpeed)
          settings.cycleSpeed = settings.slideSpeed;
  ...
  $.fn.liteAccordion = function (method) {
    ...
    if (typeof method === 'object' || !method) {
      ...
      if (method === 'debug') {
        ...
        instance[method].call(elem, arguments);
        return elem;
      }
    }
  };
