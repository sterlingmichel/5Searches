 ...
 */!function(t,e){"use strict";t.widget("simone.window",t.ui.dialog,{version:"0.1.9",options:{appendTo:"body",autoOpen:!1,buttons:[],closable:!0,closeOnEscape:!1,closeText:!1,confirmClose:{confirm:!1,modal:!1,minimizable:!0,no:null,noLocalized:"confirmCloseNo",text:null,textLocalized:"confirmCloseText",title:null,titleLocalized:"confirmCloseTitle",yes:null,yesLocalized:"confirmCloseYes"},containment:"inherit",dialogClass:"",draggable:!0,durations:{maximize:"default",minimize:"default",restore:"default",show:"default"},embeddedContent:!1,group:null,height:"auto",hide:!1,icons:{close:"ui-icon-closethick",confirmClose:"ui-icon-help",main:null,maximize:"ui-icon-arrow-4-diag",minimize:"ui-icon-minusthick",restore:"ui-icon-newwin"},maxHeight:null,maximizable:!0,maximizedDraggable:!0,maxWidth:null,minHeight:150,minimizable:!0,minWidth:150,modal:!1,modalOverlay:"all",position:{my:"center",at:"center",of:window,collision:"fit"},resizable:!0,taskbar:".simone-taskbar:eq(0)",title:null,titleLocalized:null,widgetClass:"",width:300,beforeClose:null,close:null,create:null,dragStart:null,drag:null,dragStop:null,focus:null,beforeMaximize:null,maximize:null,beforeMinimize:null,minimize:null,modalOverlaySetsCreated:null,moveToBackground:null,moveToTop:null,open:null,resizeStart:null,resize:null,resizeStop:null,beforeRestore:null,restore:null,beforeShow:null,show:null,taskbarNotFound:null},_cnst:{dataPrefix:"simone-",eventPrefix:"simonewindow",lowestPossibleZIndex:-2147483648,dimensions:["width","height"]},_titlebarButtons:["close","minimize","maximize"],_unsupportedOptions:["autoOpen","closeText","hide"],classes:{buttonMinimize:"simone-window-button-minimize",buttonMaximize:"simone-window-button-maximize-restore",windowMaximized:"simone-window-maximized",windowMinimized:"simone-window-minimized",windowMinimizing:"simone-window-minimizing",windowMaximizing:"simone-window-maximizing",windowRestoring:"simone-window-restoring",windowShowing:"simone-window-showing",taskbarButtonActive:"simone-taskbar-button-state-active",taskbarWindowCopy:"simone-taskbar-window-copy",taskbarWindowsContainment:"simone-taskbar-windows-containment",taskbarWindowButton:"simone-taskbar-window-button",taskbarHorizontal:"simone-taskbar-horizontal",window:"simone-window",unminimizable:"simone-window-unminimizable",unmaximizable:"simone-window-unmaximizable",hidden:"simone-hidden",icon:"simone-window-icon",taskbar:"simone-taskbar",coveredByOverlay:"simone-covered-by-overlay-",notCoveredByOverlay:"simone-not-covered-by-overlay-",windowContent:"simone-window-content",windowTop:"simone-window-top",button:"simone-window-button",modal:"simone-window-modal",titlebarIcon:"simone-window-titlebar-icon",dialogOverlay:"simone-window-dialog-overlay",windowOverlay:"simone-window-overlay",contentOverlay:"simone-window-content-overlay",contentOverlayed:"simone-window-content-overlayed",titlebarButtonIcon:"simone-window-titlebar-button-icon",bodyOverlay:"simone-window-body-overlay",bodyOverlayed:"simone-window-body-overlayed",confirmClose:"simone-window-type-confirm-close",confirmCloseText:"simone-window-type-confirm-close-text",confirmCloseYes:"simone-window-type-confirm-close-yes",confirmCloseNo:"simone-window-type-confirm-close-no",confirmCloseButtons:"simone-window-type-confirm-close-buttons",uiStateActive:"ui-state-active",uiStateHover:"ui-state-hover",uiStateDisabled:"ui-state-disabled",uiDialogTitle:"ui-dialog-title",uiDialogContent:"ui-dialog-content",uiDialogResizing:"ui-dialog-resizing",uiResizable:"ui-resizable",uiResizableHandle:"ui-resizable-handle",uiDraggable:"ui-draggable",uiButton:"ui-button",uiMenu:"ui-menu",uiIcon:"ui-icon",uiDialogDragging:"ui-dialog-dragging",uiDialogTitlebar:"ui-dialog-titlebar",uiDialogButtonpane:"ui-dialog-buttonpane",uiDialogButtons:"ui-dialog-buttons",uiWidgetOverlay:"ui-widget-overlay",uiButtonIconPrimary:"ui-button-icon-primary",uiButtonText:"ui-button-text"},sizeRelatedOptions:{buttons:!0,height:!0,maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0,width:!0},resizableRelatedOptions:{maxHeight:!0,maxWidth:!0,minHeight:!0,minWidth:!0},_create:function(){this._cache={inlineCSS:this.element.attr("style")||"",title:"",realTitle:this.options.title,maximized:!1,minimized:!1,restored:!0,shown:!0,maximizing:!1,restoring:!1,minimizing:!1,confirmCloseMinimizing:!1,showing:!1,initialized:!1,modalOverlayZIndex:0,animationProgress:100,suppressEvents:!1,sizes:{},closeForced:!1,closeInevitable:!1,destroyed:!1,progress:{close:!1,interaction:!1,refreshPosition:!1,restoreMaximizedDraggable:!1},refreshPositionContainment:null,timeouts:{closeWindowShow:0},taskbarsOnClickPrevention:0,resizable:{hasScrollX:!1,hasScrollY:!1,hasInlineCSS:!1,hasInlineCSSX:!1,hasInlineCSSY:!1,inlineCSS:"",inlineCSSX:"",inlineCSSY:""},draggable:{scrollX:0,scrollY:0},onInteractionEnd:[],internalCallbacks:{},newWindowNumber:!1,uep:this._cnst.eventPrefix+this.uuid},this.element.uniqueId(),this._refreshTaskbar(),this.$window=this.element,this.$close=t(),this.$confirmCloseWindow=t(),this.$maximize=t(),this.$minimize=t(),this.$latestResizableHandle=t(),this._cacheTitle(this.options.title),this._createTitleForEmpty(),this._title(),this._validateTaskbar({initial:!0}),this._debugUnsupportedOptions(),this._resetUnsupportedOptions(),this._super(),"undefined"==typeof this.options.title&&(this.options.title=null),this.$elem=t(this.bindings[0]),this.$elem.uniqueId().addClass(this.classes.window).css("position","fixed"),this.$window.addClass(this.classes.windowContent),this._debugOptions(),this.$close=this.uiDialogTitlebarClose,this.$title=this.uiDialogTitlebar.find("."+this.classes.uiDialogTitle),this._bindTaskbar(this.$taskbar),this._setTitle(),this._checkForInvalidOptions(t.simone.window.prototype.options,this.options,!0),this._setIcon({button:"close"}),this.$window.data(this._cnst.dataPrefix+"window",this)},_init:function(){var t=this;this.options.hide=!1,this.open(),this.overlay&&(this.overlay.css("zIndex",""),this.moveToTop(null,!0)),this._setWindowIcon(),this._fixTitlebarTitleWidth(),this._fullPxPosition(),this._setWidth(),this._setHeight(),this._setRestoreSize(),this.refreshPosition({skipOnFit:!0}),this._setRestoreSize(),this.$window.css({minWidth:"",minHeight:""}),this._setMinimizableMaximizableClasses(),this._fullPxPosition(),this.$elem.on("scroll."+this._cache.uep,function(){t.$elem.scrollTop(0)}),this.$elem.on("mousedown."+this._cache.uep,function(){t._preventGlobalWindowClick()}),this.$elem.on("mouseup."+this._cache.uep,function(){t._delay(function(){t._revertGlobalWindowClick()})}),this._cache.initialized=!0,this._triggerInternal("afterTaskbarBind"),this._preventGlobalWindowClick(),this._delay(function(){t._revertGlobalWindowClick()}),this._cache.destroyed||this._trigger("create")},_rebindTaskbar:function(){return this._refreshTaskbar(),this._validateTaskbar({rebind:!0})===!1?void this._triggerInternal("afterTaskbarBind"):(this._bindTaskbar(this.$taskbar),this._setConnectedButtonTitle(),this._setConnectedButtonState(),void this._languageChange())},_bindTaskbar:function(){var t=this._getTaskbarInstance();t&&(t._bind(this.$window),this.$elem.add(this.overlay).attr("data-taskbar-uuid",this._getTaskbarInstance().uuid))},_taskbarUnbind:function(){var t=this._getTaskbarInstance();t&&t._unbind(this.$window),this.$elem.removeAttr("data-taskbar-uuid")},_refreshTaskbar:function(){this.$taskbar=this.options.taskbar instanceof t?this.options.taskbar:t(this.options.taskbar),this.$taskbar=this.$taskbar.filter(":eq(0)")},_getTaskbarInstance:function(){return this._validateTaskbar(),this.$taskbar.data(this._cnst.dataPrefix+"taskbar")},_hasTaskbar:function(){var t=this._taskbarStatus(),e=!t.isEmptyDomObject&&t.isTaskbar;return e},_taskbarStatus:function(){return{isEmptyDomObject:this.$taskbar instanceof t&&!this.$taskbar.length,isTaskbar:this.$taskbar.hasClass(this.classes.taskbar),isPlugin:!!t.simone.taskbar}},_validateTaskbar:function(t){var e=this._taskbarStatus();if(e.isEmptyDomObject||!e.isTaskbar||!e.isPlugin){var i={taskbar:this.options.taskbar,$taskbar:this.$taskbar},s={isEmptyDomObject:'jQuery object passed in "taskbar" option is empty.',isTaskbar:'jQuery object passed in "taskbar" option is not an instance of taskbar, call $("#selector").taskbar(); first.',isPlugin:"Taskbar plugin is missing."};if(t&&(t.initial||t.rebind)){for(var n in e)if(e[n]===!0&&"isEmptyDomObject"===n||e[n]===!1&&"isEmptyDomObject"!==n){i.message="Window #"+this.element[0].id+": "+s[n]+(t.rebind?" Window was not rebinded.":" Window was not created."),i.initial=!t.rebind;break}var o=this._trigger("taskbarNotFound",{},i),a=this;this._bindInternal("afterTaskbarBind",function(){t.initial&&a.destroy(),o!==!1&&(t.rebind?console&&console.warn?console.warn(i.message):null:console&&console.error?console.error(i.message):null)})}return!1}return!0},_refreshGroup:function(){this._taskbarUnbind(),this._bindTaskbar()},_debugOptions:function(){var t=this._getTaskbarInstance();if(t){var e=this.options;e.minWidth>e.maxWidth&&null!==e.minWidth&&null!==e.maxWidth&&this._debugLogAdd('"minWidth" option should not be higher than "maxWidth" option.',1,2),e.minHeight>e.maxHeight&&null!==e.minHeight&&null!==e.maxHeight&&this._debugLogAdd('"minHeight" option should not be higher than "maxHeight" option.',1,2),"function"!=typeof e.show&&null!==e.show&&this._debugLogAdd('option "show" should either be a function or null.',1,2)}},_debugUnsupportedOptions:function(){var e=this._getTaskbarInstance();if(e){var i=this;t.each(this._unsupportedOptions,function(t,e){if(i.options[e]!==!1){var s='"'+e+'" option is not supported and will be set to false.';"closeText"===t&&(s+=" Use built in localization instead."),i._debugLogAdd(s,1,2)}})}},_resetUnsupportedOptions:function(){this.options.autoOpen=!1,this.options.closeText=!1,this.options.hide=!1},_triggerInternal:function(t){"function"==typeof this._cache.internalCallbacks[t]&&(this._cache.internalCallbacks[t](),this._cache.internalCallbacks[t]=null)},_bindInternal:function(t,e){this._cache.internalCallbacks[t]=e},_createWrapper:function(){var e=this;this._super(),this.uiDialog.addClass(this.options.widgetClass),this.uiDialog.on("keydown."+this._cache.uep,function(i){!e.options.closable&&e.options.closeOnEscape&&i.keyCode===t.ui.keyCode.ESCAPE&&i.preventDefault()}),this._off(this.uiDialog,"mousedown"),this.uiDialog.on("mousedown."+this._cache.uep,function(t){(1===t.which||2===t.which)&&e._moveToTop(t)&&e._focusTabbable()});var i=t._data(this.uiDialog[0]).events.keydown;t.each(i,function(t,s){return"number"==typeof t&&i.hasOwnProperty(t)&&-1!==s.namespace.indexOf(e._cache.uep)?(i[t]=[i[0],i[0]=i[t]][0],!1):void 0})},_freezeBodyScrollbars:function(){var e=t("body"),i=document.documentElement,s=this._cache;s.resizable.hasScrollX=i.scrollWidth!==i.clientWidth,s.resizable.hasScrollY=i.scrollHeight!==i.clientHeight,s.resizable.hasInlineCSS=this._hasInlineProperty(e,"overflow"),s.resizable.hasInlineCSSX=this._hasInlineProperty(e,"overflow-y"),s.resizable.hasInlineCSSY=this._hasInlineProperty(e,"overflow-x"),s.inlineCSS=e.css("overflow"),s.inlineCSSX=e.css("overflow-x"),s.inlineCSSY=e.css("overflow-y");var n=s.resizable;e.css({overflow:"inherit",overflowY:n.hasScrollY?"scroll":"hidden",overflowX:n.hasScrollX?"scroll":"hidden"})},_revertBodyScrollbars:function(){var e=this._cache.resizable,i=t("body");i.css({overflow:e.hasInlineCSS?e.inlineCSS:"",overflowX:e.hasInlineCSSX?e.inlineCSSX:"",overflowY:e.hasInlineCSSY?e.inlineCSSY:""})},_makeResizable:function(){function e(t){return{originalPosition:t.originalPosition,originalSize:t.originalSize,position:t.position,size:t.size}}var i,s,n=this,o=(this.uiDialog,this.options),a=o.resizable,r="string"==typeof a?a:"n,e,s,w,se,sw,ne,nw",l={},h=function(e,i){var s=t(this);t.each(["width","height"],function(t,e){i.size[e]=Math.round(i.size[e]),s.css(e,i.size[e])}),t.each(["top","left"],function(t,e){i.position[e]=Math.round(i.position[e]),s.css(e,i.position[e])});var o=n._getDimensions.call(s,{outer:!0}),a=n._cache.sizes.containment,r=n._getDimensions.call(t("."+n.classes.taskbarWindowCopy),{outer:!0}),l=n._cache.sizes.margins,h=n._getTaskbarInstance();if(h)var c=n._getDimensions.call(h.$windowsContainment,{outer:!0});t.each(["top","left"],function(e,h){var d,u=t(window)["scroll"+n._ucFirst(h)](),m="top"===h,p=i.position[h]+u,g=p,f=m?"height":"width",_=m?"bottom":"right",b=o[h]+o[f]-u-r[f]+l[_],w=i.size[f];if(s.css(h,p),p<a[h]+u&&(b=a[h]+u-p),p=Math.round(Math.max(p,u+a[h])),d=p-g,0!==d&&(s.css(h,p),i.position[h]=p),w=a[f]-Math.max(p-a[h],0)-(a[_]-o[_]),w+=u,w=Math.round(w-Math.max(b,0))+d,s.css(f,w),c){var v=s["outer"+n._ucFirst(f)](),C=Math.min(0,c[_]-(v+p));w+=C}s.css(f,w),i.size[f]=w})},c=function(e,i){var s=t(this),o=n._bringIntoView({diffs:!0});t.each(["top","left"],function(e,a){var r=t(window)["scroll"+n._ucFirst(a)](),l="top"===a,h=i.position[a]+r,c=l?"height":"width",d=l?"bottom":"right",u=i.position[a]>i.originalPosition[a]?"less":"more",m=i.size[c];s.css(a,h);var p=!1;o[a]+r<0&&"more"===u&&(p=!0,h-=o[a]+r,m+=o[a]+r),o[d]<0&&"less"===u&&(p=!0,h+=o[d],m-=o[d]),p&&(h=Math.round(h),m=Math.round(m),s.css(a,h).css(c,m),i.position[a]=h,i.size[c]=m)})},d=function(t,e,i){n._versionOf("resizable",">=","1.11.1")&&i._mouseDrag(t),"viewport"===n._getRealContainment()?h.call(this,t,e):c.call(this,t,e)};this.uiDialog.resizable({cancel:"."+this.classes.uiDialogContent,alsoResize:null,aspectRatio:!1,maxWidth:o.maxWidth,maxHeight:o.maxHeight,minWidth:o.minWidth,minHeight:this._minHeight(),handles:r,start:function(i,o){n._interactionInProgress(!0),n._hideTaskbarsSubordinates(),n._freezeBodyScrollbars(),n._versionOf("dialog",">=","1.10.1")&&n._blockFrames(),l=n._getDimensions.call(n.$elem,{outer:!0});var a=t(this);s=a.data(n.classes.uiResizable),a.addClass(n.classes.uiDialogResizing);var r=n._getWindowScroll(),h=Math.round(parseFloat(a.css("top")))+r.y,c=Math.round(parseFloat(a.css("left")))+r.x;a.css({top:h,left:c,position:"absolute"}),n._trigger("resizeStart",i,e(o))},stop:function(i,a){var r=t(this);o.height=r.height(),o.width=r.width(),r.removeClass(n.classes.uiDialogResizing),n._versionOf("resizable",">=","1.11.1")&&d.call(this,i,a,s);var l=n._getWindowScroll(),h=Math.round(parseFloat(r.css("top")))-l.y,c=Math.round(parseFloat(r.css("left")))-l.x;r.css({top:h,left:c,position:"fixed"}),n._interactionInProgress(!1),n._revertBodyScrollbars(),n._versionOf("dialog",">=","1.10.1")&&n._unblockFrames(),n._fullPxPosition(),n._refreshPositionOption(),n._setRestoreSize(),n._setContainment(),n._trigger("resizeStop",i,e(a))},resize:function(t,i){d.call(this,t,i,s),n._fixTitlebarTitleWidth(),n._fullPxPosition(),n._setContentHeight(),n._trigger("resize",t,e(i))}}),i=this.uiDialog.data(this.classes.uiResizable),i._updateRatio=function(t){return t},t(this.bindings[0]).children("."+this.classes.uiResizableHandle).on("mousedown."+this._cache.uep,function(){n.$latestResizableHandle=t(this)})},_freezeBodyScrolls:function(){this._cache.draggable.scrollX=t(window).scrollLeft(),this._cache.draggable.scrollY=t(window).scrollTop()},_revertBodyScrolls:function(){window.scroll(this._cache.draggable.scrollX,this._cache.draggable.scrollY)},_refreshPositionOption:function(){var e=this.options,i=this.$elem;if(e.position=[parseInt(i.css("top"),10)-t(window).scrollLeft(),parseInt(i.css("left"),10)-t(window).scrollTop()],this._versionOf("dialog",">=","1.11.0")){var s=e.position[1]-t(window).scrollLeft(),n=e.position[0]-t(window).scrollTop();e.position={my:"left top",at:"left"+(s>=0?"+":"")+s+" top"+(n>=0?"+":"")+n,of:window}}},_makeDraggable:function(){function e(e,i){n._cache.progress.restoreMaximizedDraggable=!0;{var s=o.data(n.classes.uiDraggable),a=n._getTaskbarInstance(),r=n.uiDialogTitlebar.find("."+n.classes.uiDialogTitle),l=r.siblings("."+n.classes.uiButton+":visible:eq(0)");t.extend(!0,{},s)}n.restore(!1),s._mouseStop(e);var h=a._extendedPosition.call(o,"offset"),c=a._extendedPosition.call(r,"offset"),d=a._extendedPosition.call(l.length?l:r,"offset"),u={},m=n._getWindowScroll(),p=parseFloat(o.css("top"))-(h.top-i.originalPosition.top)+m.y;u.left=e.pageX-d.right,u.right=e.pageX-c.left;var g=0;u.left<0?g=u.left+c.width:u.right>0&&(g=u.right-(c.width+(d.right-c.right)));var f=parseFloat(o.css("left"))+g;o.css({top:p,left:f}),s._mouseStart(e),s._mouseStop(e),s._mouseStart(e);t.extend(!0,{},s);i.position.top=s.offset.top-t(window).scrollTop(),i.position.left=s.offset.left-t(window).scrollLeft(),n._cache.progress.restoreMaximizedDraggable=!1}function i(t,e){e.position.top=Math.round(parseFloat(e.position.top)),e.position.left=Math.round(parseFloat(e.position.left))}function s(t){return{position:t.position,originalOffset:a,originalPosition:r,offset:t.offset}}this._super();var n=this,o=this.uiDialog,a=(this.options,{}),r={};o.draggable("option",{scroll:!1,distance:1,iframeFix:!0,start:function(e,i){n.$elem.data(n._cnst.dataPrefix+"window-scrolls",{x:t(window).scrollLeft(),y:t(window).scrollTop()}),n._versionOf("dialog",">=","1.10.1")&&n._blockFrames(),n._interactionInProgress(!0),n._interactionsState(!0),n._hideTaskbarsSubordinates(),n._freezeBodyScrolls(),a=n.$elem.offset(),r=n.$elem.position(),n._trigger("dragStart",e,s(i))},stop:function(e,i){t(this).removeClass(n.classes.uiDialogDragging),n._interactionInProgress(!1),n._versionOf("dialog",">=","1.10.1")&&n._unblockFrames(),n._fullPxPosition(),n._refreshPositionOption(),n._setRestoreSize(),n._revertBodyScrolls(),n.$elem.removeData(n._cnst.dataPrefix+"window-scrolls"),n._trigger("dragStop",e,s(i))},drag:function(o,a){if(n.maximized()&&n.options.maximizedDraggable&&e(o,a),i(o,a),n._versionOf("dialog",">=","1.11.0")){var r=n.$elem.data(n._cnst.dataPrefix+"window-scrolls");a.position.left+=r.x-t(window).scrollLeft(),a.position.top+=r.y-t(window).scrollTop()}n._trigger("drag",o,s(a))}}),this._extendDraggableCancel(),this._setContainment()},_getRealContainment:function(){var t=this._getTaskbarInstance();return"inherit"===this.options.containment&&t?t.options.windowsContainment:this.options.containment},_getRealContainmentObject:function(){return t("."+this.classes.taskbarWindowsContainment)},_getVisibleContainmentArray:function(){var t,e,i,s,n,o=this._getTaskbarInstance();this._refreshTaskbarMargins();var a,r=this._cache.sizes.margins;if(this.bindings[0].length)a=this.bindings[0];else if(this.$elem.length)a=this.$elem;else{if(!this.element.length)return[0,0,0,0];a=this.element.parent()}var l=o._extendedPosition.call(a),h=o._extendedPosition.call(this._getRealContainmentObject(),"offset"),c=o._extendedPosition.call(this.uiDialogTitlebar.find("."+this.classes.uiDialogTitle),"offset"),d=this._bringIntoViewReserve(),u=this._getWindowScroll();return e=u.x+r.left,s=u.y+r.top,i=e+u.x+h.width-l.width,n=s+h.height-l.height-u.y,e-=c.width,s-=c.bottom-l.top-d-u.y,i+=c.width-(c.right-l.right)-d,n+=2*u.y+l.height-(c.top-l.top)-d,t=[e,s,i,n]},_getWindowScroll:function(){return this._getTaskbarInstance()._getWindowScroll()},_setContainment:function(){var e=this._getRealContainment();if(t.ui.draggable&&this.options.draggable&&this.uiDialog.hasClass(this.classes.uiDraggable)){var i;"viewport"===e?i=this._getRealContainmentObject():"visible"===e&&(i=this._getVisibleContainmentArray()),this.uiDialog.draggable("option","containment",i)}t.ui.resizable&&this.options.resizable&&this.uiDialog.hasClass(this.classes.uiResizable)&&("viewport"===e?this.uiDialog.resizable("option","containment","document"):"visible"===e&&this.uiDialog.resizable("option","containment",!1))},_extendDraggableCancel:function(){var t=this.uiDialog.draggable("option","cancel");-1===t.indexOf(this.classes.button)&&(t+=", ."+this.classes.button+", ."+this.classes.icon,this.uiDialog.draggable("option","cancel",t))},_openConfirmClose:function(){var e=this,i=this.options;if(i.confirmClose.confirm&&!this._cache.progress.close){this._placeOverlay({window:!0}),this.$confirmCloseWindow=t("<div></div>"),this.$confirmCloseWindow.addClass(this.classes.confirmClose).append(t("<p>"+this._buildConfirmCloseText("text")+"</p>").addClass(this.classes.confirmCloseText)).window({taskbar:this.$taskbar,minimizable:i.confirmClose.minimizable,modal:i.confirmClose.modal,containment:i.containment,durations:i.durations,icons:{main:i.icons.confirmClose},title:this._buildConfirmCloseText("title"),buttons:this._confirmCloseButtonsConfig(),closeOnEscape:!0,maximizable:!1,resizable:!1,height:"auto",minHeight:null,beforeMinimize:function(){e._cache.confirmCloseMinimizing=!0},minimize:function(){e._cache.confirmCloseMinimizing=!1},close:function(){e._unblock()}}),this._afterConfirmCloseButtonsBuild(),this._removeTopClasses(),this.$confirmCloseWindow.window("moveToTop");var s=this.$confirmCloseWindow.parent(),n=this._getTaskbarInstance(),o=n._extendedPosition.call(s,"offset"),a=n._extendedPosition.call(this.$elem,"offset"),r={},l=this._getWindowScroll();return r.top=a.top-l.y,r.left=a.left-l.x,r.top-=(o.height-a.height)/2,r.left-=(o.width-a.width)/2,s.css(r).attr("data-close-window-for",e.$elem.attr("id")),this.$confirmCloseWindow.window("refreshPosition"),this._cache.progress.close=!0,!0}return!1},_confirmCloseButtonsConfig:function(){var t=this;return[{text:this._buildConfirmCloseText("no"),click:function(){t.$confirmCloseWindow.window("close")}},{text:this._buildConfirmCloseText("yes"),click:function(){t.close(),t._closeConfirmCloseWindow()}}]},_afterConfirmCloseButtonsBuild:function(){var e=[this.classes.confirmCloseNo,this.classes.confirmCloseYes];t("."+this.classes.uiDialogButtonpane,this.$confirmCloseWindow.parent()).addClass(this.classes.confirmCloseButtons).find("."+this.classes.uiButton).each(function(i){t(this).addClass(e[i])})},_buildConfirmCloseText:function(t){var e=this.options,i={title:this.title()};return e.confirmClose[t]?this._getTaskbarInstance()._i18n_replace_keys(e.confirmClose[t],i):this._i18n(e.confirmClose[t+"Localized"],i)},_propagateConfirmCloseOptions:function(e,i){var s,n,o=this;"object"!=typeof e?(s={},s[e]=i):(s=e,n=!!i),t.each(s,function(e,i){if(o.$window.hasClass(o.classes.confirmClose)&&"confirmClose"===e){var s=o._getTaskbarInstance();if(!s)return;o._debugLogAdd("Trying to change confirmClose option on a window that is a confirm close window itself. Confirm close windows should not be nested.",1,2)}if(o.$confirmCloseWindow.length){if("durations"===e&&o.$confirmCloseWindow.window("option","durations",o.options.durations),"confirmClose"===e){var a=o.options.confirmClose,r=["modal","minimizable"],l=["title"],h=["text"],c=["yes","no"];t.each(r,function(t,e){(i[e]!==a[e]||n)&&o.$confirmCloseWindow.window("option",e,a[e])});var d=function(t){return i[t]!==a[t]||i[t+"Localized"]!==a[t+"Localized"]||n};t.each(l,function(t,e){d(e)&&o.$confirmCloseWindow.window("option",e,o._buildConfirmCloseText(e))}),t.each(h,function(t,e){var i=o._ucFirst(e);d(e)&&o.$confirmCloseWindow.find("."+o.classes["confirmClose"+i]).text(o._buildConfirmCloseText(e))}),t.each(c,function(t,e){d(e)&&(o.$confirmCloseWindow.window("option","buttons",o._confirmCloseButtonsConfig()),o._afterConfirmCloseButtonsBuild())})}"icons"===e&&o.$confirmCloseWindow.window("option","icons.main",o.options.icons.confirmClose),"title"===e&&o.$confirmCloseWindow.window("option","title",o._buildConfirmCloseText("title")),"taskbar"===e&&o.$confirmCloseWindow.window("option","taskbar",o.$taskbar)}})},_closeConfirmCloseWindow:function(){var e=this;this.$confirmCloseWindow.length&&(this.$confirmCloseWindow.window("option",{beforeClose:t.noop,close:function(){e._unblock()}}).window("close"),this.$confirmCloseWindow=t())},_unblock:function(){this.$confirmCloseWindow=t(),this._placeOverlay({destroy:!0,window:!0}),this._cache.progress.close=!1},_i18n:function(t,e,i){var s=this._getTaskbarInstance();return s?s._i18n(t,e,i):t},_createTitlebar:function(){if(this._super(),this._hasTaskbar()){var e=this;this.uiDialogTitlebarClose.off("click").on("click."+this._cache.uep,function(t){t.preventDefault(),e.options.closable&&e.close(t)}),this._setButtonCloseState(),this.uiDialogTitlebarClose.attr("data-button-name","close"),this.$elem=this.uiDialog.closest("."+this.classes.uiDialog),this._createButton("maximize"),this._createButton("minimize"),this.uiDialogTitlebar.on("dblclick."+this._cache.uep,function(i){return t(i.target).hasClass(e.classes.uiDialogTitlebar)||t(i.target).hasClass(e.classes.uiDialogTitle)?e.options.maximizable?(e._blurActiveElement(!0),void e._toggleMaximized()):!0:!1})}},_setButtonCloseState:function(){this.uiDialogTitlebarClose.button("option","label",this._i18n("close")),this._addButtonClasses(this.uiDialogTitlebarClose),this.uiDialogTitlebarClose.toggleClass(this.classes.hidden,!this.options.closable),this._enumerateTitlebarButtons()},_createButton:function(e){var i=this;"string"==typeof e&&(e={button:e});var s=e.button,n=this._ucFirst(s);return this.$elem.find("."+this.classes["button"+n]).remove(),"maximize"===s&&!this.options.maximizable||"minimize"===s&&!this.options.minimizable?void this._enumerateTitlebarButtons():(this["$"+s]=t("<button></button>").button({text:!1}).attr("data-button-name",s).addClass(this.classes["button"+n]+" "+this.classes.button).on({click:function(){"minimize"===s?i[s]():i._toggleMaximized(),"minimize"===s?this.blur():i.moveToTop()},mousedown:function(){t(this).siblings("."+i.classes.uiButton).removeClass(i.classes.uiStateHover),"maximize"===s&&this.focus()}}),this._setIcon({button:s}),this._setButtonText({button:s}),"minimize"===s?this["$"+s].appendTo(this.uiDialogTitlebar):this["$"+s].insertAfter(this.uiDialogTitlebarClose),void this._enumerateTitlebarButtons())},_speedUpAnimation:function(e,i){return"string"==typeof this.options.durations[e]?t.fx[this.options.durations[e]]:this.options.durations[e]*i},_moveToTop:function(e,i){var s=this,n=e&&e.type,o=e&&e.highest===!0,a=e&&e.skipThis===!0,r=e&&e.skipMinimizing===!0,l=e&&e.blurModals===!0,h=t(),c=document.activeElement,d=this._getActiveModal().filter(":visible").not("."+this.classes.windowMinimizing),u=this._getTaskbarInstance(),m=t();if(u&&(d.length&&!this.options.modal&&(a=!0),!this._cache.minimizing||!n)){var p=this.$elem.hasClass(this.classes.windowTop);this._cache.progress.close&&!a&&(o=!0,!this._cache.confirmCloseMinimizing&&s.$confirmCloseWindow.length&&(h=h.add(s.$confirmCloseWindow)));var g=u.options.windowsInitialZIndex,f=a?null:this.$elem,_=t("."+this.classes.window).not(r?null:"."+this.classes.windowMinimizing).not("."+this.classes.bodyOverlayed).add(a?this.$elem:null).not(f).not(h).not("."+this.classes.modal).filter(":visible");t("."+this.classes.taskbar).each(function(){var e=t(this),i=e.data(s._cnst.dataPrefix+"taskbar");m=m.add(i.windows().parent().filter("."+s.classes.modal).filter("."+s.classes.windowTop).not("."+s.classes.windowMinimizing).filter(":visible"))}),m=m.not(f);var b=this._sortByZIndex(_,"asc","raw");o&&(f=b.length?b.pop()[1]:null),f===this.$elem&&!a&&this.options.modal&&(this._revertActiveModalZIndexes(),this._minimizeOtherModals({skipZIndexRevert:!0})),this._removeTopClasses(_.add(o?this.$elem:null).not(d)),_.each(function(){t(this).children("."+s.classes.windowContent).data(s._cnst.dataPrefix+"window")._placeOverlay({window:"auto"})}),t.each(b,function(t,e){e[1].css("zIndex",g),g++});var w;if(f instanceof t){if(a)f[0].id!==this.$elem.attr("data-close-window-for")&&(w=!0);else if(f===this.$elem){var v=c===this.$elem[0]||t.contains(this.$elem[0],c),C=this.$elem.hasClass(this.classes.windowTop),k=parseInt(f.css("zIndex"),10);f.css("zIndex",Math.max(g,k)),f.hasClass(this.classes.bodyOverlayed)||this._setTopClasses(f),C||i||!n&&v||(this._focusTabbable(),this._trigger("focus",e)),this.options.modal&&this._modalZIndexes({revertActive:!1}),f.add(d).each(function(){t(this).children("."+s.classes.windowContent).data(s._cnst.dataPrefix+"window")._setConnectedButtonState()})}else w=!0;if(w)return void f.children("."+this.classes.windowContent).window("moveToTop")}return l&&this._removeTopClasses(m),this.$elem.hasClass(this.classes.bodyOverlay)||this._placeOverlay({destroy:!0}),l||f===this.$elem||this._setTopModalState(f),f!==this.$elem||p||this._cache.progress.close||this._trigger("moveToTop",e),f!==this.$elem||a||o||p?void 0:!0}},_setTopClasses:function(t){var e=t?t:this.$elem;e.addClass(this.classes.windowTop).children("."+this.classes.uiDialogTitlebar).addClass(this.classes.uiStateActive),this._setConnectedButtonsState(e.children("."+this.classes.windowContent))},_removeTopClasses:function(e){var i=e?e:this.$elem,s=this;i.each(function(){var e=t(this);e.hasClass(s.classes.windowTop)&&(e.removeClass(s.classes.windowTop).children("."+s.classes.uiDialogTitlebar).removeClass(s.classes.uiStateActive),e.children("."+s.classes.windowContent).data(s._cnst.dataPrefix+"window")._trigger("moveToBackground",{},{}))}),this._setConnectedButtonsState(i.children("."+this.classes.windowContent))},_setConnectedButtonsState:function(e){var i=this;e.each(function(){t(this).data(i._cnst.dataPrefix+"window")._setConnectedButtonState()})},_animate:function(t,e){e.duration===!1?(this.css(t),e.start&&e.start(),e.complete&&e.complete(),e.always&&e.always()):this.animate(t,e)},_close:function(e){if(this._onInteractionEnd("close")!==!0&&!this._cache.closeInevitable){if(!this._cache.closeForced){if(this._openConfirmClose()===!0)return;if(this._trigger("beforeClose",e)===!1)return}this._cache.closeInevitable=!0,this._clearTimeouts(),this._closeConfirmCloseWindow(),this._taskbarUnbind(),this._revertModalZIndexes({force:!0}),this.options.durations={minimize:!1},this._hideOverlay(),this._isOpen=!1,this._destroyOverlay(),this.destroy(),this.opener.filter(":focusable").focus().length||t(this.document[0].activeElement).blur(),this._trigger("close",e,{})}},show:function(t){var i=t===!1,s=this._parseDuration(t);if((!this._animationProgress()||t&&s&&(!t||"dblclick"===t.type)||i)&&this._onInteractionEnd("minimize",t)!==!0){var n={};if(this._cache.suppressEvents||this._trigger("beforeShow",t,n)!==!1){this.$elem.removeClass(this.classes.windowMinimized),this._cache.minimized&&this.$elem.css(this._getButtonCoordinates()),this._cache.showing||this.$elem.stop(!0,i),this._cache.minimized=!1,this._cache.showing=!0;var o,a=this._cache.animationProgress,r=this._cache.minimizing?this.options.durations.minimize:e;this.moveToTop();var l=this,h=this._cache.maximized?this._cache.sizes.containment:this._cache.sizes.self;r!==e&&(o=this._speedUpAnimation("minimize",a)),h.opacity=1,this._deleteBottomRight(h),this.$elem.show().addClass(this.classes.windowShowing),this._interactionsState(!1);var c=this._cache.shown||t&&"dblclick"===t.type||i?!1:o||s||this.options.durations.show;this._cache.shown=!0;var d={duration:c,complete:function(){l._fixTitlebarTitleWidth(),l._setContentHeight(),l._focusTabbable(),l.$elem.hasClass(l.classes.windowTop)&&l._trigger("focus")},progress:function(){l._fixTitlebarTitleWidthDuringAnimation.apply(l,arguments),l._setContentHeight()},always:function(){l.$elem.removeClass(l.classes.windowShowing).removeClass(l.classes.windowMaximizing).removeClass(l.classes.windowRestoring),l._cache.showing=!1,l._interactionsState(!0),l.refreshPosition(),l.$elem.css("opacity",""),l._setRestoreSize();var t={};l._triggerInternal("afterWindowAnimationStop"),l._cache.suppressEvents||l._trigger("show",{},t)}};this._animate.call(this.$elem,h,d),this._createOverlay(),this._showOverlay()}}},_minimize:function(t){var e=t===!1,i=this._parseDuration(t);if((!this._animationProgress()||e||this._isMinimizeAllInProgress())&&this._onInteractionEnd("minimize",t)!==!0){var s=this,n=t&&t.skipZIndexRevert,o={minimizeAllInProgress:this._isMinimizeAllInProgress()};if(this._cache.suppressEvents||this._trigger("beforeMinimize",{},o)!==!1){if(this._clearTimeouts(),this._cache.progress.close){var a=s.$confirmCloseWindow.window("option","durations.minimize");s.$confirmCloseWindow.window("option","durations.minimize",e?!1:s.options.durations.minimize).window("minimize").window("option","durations.minimize",a)}n||this._revertModalZIndexes(),this.$elem.addClass(this.classes.windowMinimizing),this._isMinimizeAllInProgress()||n||this._moveToTop({highest:!0}),(this._isMinimizeAllInProgress()||n)&&this.$elem.removeClass(this.classes.windowTop),n&&this._revertModalZIndexes({$elem:this.$elem});
var r=this._getButtonCoordinates(),l=e?!1:i||this.options.durations.minimize;this.$elem.stop(!0,e),this._blurActiveElement(!0),this._cache.minimizing=!0,this._interactionsState(!1);var h={duration:l,complete:function(){s._fixTitlebarTitleWidth(),s._setContentHeight()},progress:function(){s._fixTitlebarTitleWidthDuringAnimation.apply(s,arguments),s._setContentHeight()},always:function(){s.$elem.hide().addClass(s.classes.windowMinimized).removeClass(s.classes.windowMinimizing),s._cache.minimizing=!1,s._cache.minimized=!0,s._cache.shown=!1,s._destroyOverlay({justDestroy:!0});var t={minimizeAllInProgress:s._isMinimizeAllInProgress()};s._cache.suppressEvents||s._trigger("minimize",{},t),s._triggerInternal("afterWindowAnimationStop")}};this._hideOverlay(),this._animate.call(this.$elem,r,h)}}},_toggleMaximized:function(e,i){"undefined"==typeof e&&(e=!this.maximized());var s=i===!1,n=this._parseDuration(i),o=e?"maximize":"restore",a=e?"restore":"maximize",r=e?"maximized":"restored",l=e?"restored":"maximized",h="before"+this._ucFirst(o),c={};if(this._cache.progress.restoreMaximizedDraggable||this._onInteractionEnd(a,i)!==!0){var d=this,u=e?"maximizing":"restoring",m=e?"restoring":"maximizing",p="restore"===a&&this._cache.maximizing||"maximize"===a&&this._cache.restoring||this._cache.minimizing||this._cache.showing,g=this._cache.animationProgress;if((!this._animationProgress()||this._animationProgress(m)||s)&&(this._cache.suppressEvents||this._trigger(h,{},c)!==!1)){if(this._cache.minimized&&!this._cache.minimizing){this._cache.suppressEvents=!0,this.$elem.removeClass(this.classes.windowMinimized);var f=t.extend(!0,{},this.options.durations);return this.options.durations=t.extend(!0,{},this._noAnimationDurations()),this.show(),e?this.maximize():this.restore(),this.minimize(),this.$elem.addClass(e?this.classes.windowMaximizing:this.classes.windowRestoring),this.options.durations=f,this.show(i),this._cache[r]=!0,this._cache[l]=!1,this.$elem.removeClass(this.classes.windowShowing),this._cache.suppressEvents=!1,void this._trigger(e?"maximize":"restore",{},{})}this._cache.maximized=e,this._cache.restored=!e,this._cache.minimized=!1,this.$elem.find("."+this.classes.uiDialogTitlebar+" ."+this.classes.uiButton).removeClass(this.classes.uiStateHover),e||this.$elem.removeClass(this.classes.windowMaximized),this.$elem.stop(!0,s).addClass(this.classes.window+"-"+u),this._cache[u]=!0,this._cache[m]=!1,this.$maximize&&this.$maximize.length&&this.$maximize.closest(this.uiDialogTitlebar).length&&(this._setButtonText({button:"maximize",label:a}),this._setIcon({icon:a,button:"maximize"})),this._interactionsState(!1);var _=e?this._cache.sizes.containment:this._cache.sizes.self;this._deleteBottomRight(_),_.opacity=1;var b=p?this._speedUpAnimation(o,g):this.options.durations[o],w={duration:s?!1:n||b,complete:function(){d._fixTitlebarTitleWidth(),d._setContentHeight()},progress:function(){d._fixTitlebarTitleWidthDuringAnimation.apply(d,arguments),d._setContentHeight()},start:function(){d._cache.shown=!0},always:function(){d._cache[u]=!1,d._cache[m]=!1,d._cache[r]=!0,d._cache[l]=!1,d.$elem.removeClass(d.classes.window+"-"+u).toggleClass(d.classes.windowMaximized,e).css("opacity",""),d._interactionsState(!e);var t={};d._triggerInternal("afterWindowAnimationStop"),d._fullPxPosition(),e||p||d._setRestoreSize(),d._cache.suppressEvents||d._trigger(o,{},t)}};this._animate.call(this.$elem,_,w),this._showOverlay()}}},_animationProgress:function(t){return t?this._cache[t]:this._cache.showing||this._cache.maximizing||this._cache.minimizing||this._cache.restoring},_noAnimationDurations:function(){return{maximize:!1,minimize:!1,show:!1,restore:!1}},_enumerateTitlebarButtons:function(){this.uiDialogTitlebar.children("."+this.classes.uiButton).removeAttr("data-button-order"),this.uiDialogTitlebar.children("."+this.classes.uiButton+":not(."+this.classes.hidden+")").each(function(e){t(this).attr("data-button-order",e)})},_setConnectedButtonState:function(){t("."+this.classes.taskbar+" ."+this.classes.taskbarWindowButton).removeClass(this.classes.uiStateActive);var e=this._getTaskbarInstance();if(e){var i=this.$taskbar.taskbar("button",this.$window);i.length&&e._setConnectedButtonState.call(i[0],e)}},_setWidth:function(){this._setDimension("width"),this._setContentHeight()},_setHeight:function(){this._setDimension("height"),this._setContentHeight()},_setDimension:function(t){var e=this.options,i=e[t],s="min"+this._ucFirst(t),n="max"+this._ucFirst(t),o=e[s],a=Math.round(parseFloat(this.$elem.css(t))),r=this._cache.sizes.containment,l=this._getRealContainment();"auto"===i&&(this.$elem.css(t,""),this.$window.css(n,""),a=Math.round(parseFloat(window.getComputedStyle(this.$elem[0])[t]))),i=this._cache.maximized?r[t]:i===parseInt(i,10)?Math.max(o,i):Math.max(o,a),"viewport"===l&&r&&(i=Math.round(Math.min(i,r[t]))),this.$elem.css(t,i)},_setIcon:function(t){"undefined"==typeof t.icon&&(t.icon=t.button),this["$"+t.button].button("option","icons.primary",this.options.icons[t.icon]),this._addButtonClasses(this["$"+t.button])},_refreshButtonIcons:function(){this._setIcon({button:"close"}),this._setIcon({button:"minimize"}),this._setIcon({icon:this._cache.maximized?"restore":"maximize",button:"maximize"})},_setButtonsTexts:function(){var i=this;t.each(this._titlebarButtons,function(t,s){var n=i["$"+s];n&&n.length&&n.hasClass(i.classes.uiButton)&&i._setButtonText({button:s,label:"maximize"===s?i._cache.maximized?"maximize":"restore":e})})},_setButtonText:function(t){this["$"+t.button].button("option","label",this._i18n(t.label||t.button)),this._addButtonClasses(this["$"+t.button])},_addButtonClasses:function(t){t.find("."+this.classes.uiButtonIconPrimary+", ."+this.classes.uiButtonText).addClass(this.classes.titlebarButtonIcon)},_interactionsState:function(t){this._draggableState(t),this._resizableState(t)},_interactionInProgress:function(e){if("undefined"==typeof e)return this._cache.progress.interaction;if(this._cache.progress.interaction=e,e===!1){var i=this._cache.onInteractionEnd.length;if(i){for(var s=0;i>s;s++){var n=this._cache.onInteractionEnd[s];if(t.inArray(n.action,["close","destroy"])>-1){this[n.action]();break}(n.quick===!1||s+1===i)&&this[n.action](n.quick)}this._cache.onInteractionEnd=[]}}},_onInteractionEnd:function(t,e){return this._interactionInProgress()===!0?(this._cache.onInteractionEnd.push({action:t,quick:e}),!0):void 0},_draggableState:function(t){if(this.$elem.hasClass(this.classes.uiDraggable)){var e=this.options.maximizedDraggable&&this._cache.maximized&&!this._animationProgress(),i=(t||e)&&this.options.draggable;this.$elem.draggable(i?"enable":"disable")}this._removeClassDisabled()},_resizableState:function(t){this.$elem.hasClass(this.classes.uiResizable)&&this.$elem.resizable(t&&this.options.resizable?"enable":"disable"),this._removeClassDisabled()},_clearTimeouts:function(){clearTimeout(this._cache.timeouts.closeWindowShow)},_removeClassDisabled:function(){this.$elem.removeClass(this.classes.uiStateDisabled)},_setRestoreSize:function(){if(!this.maximized()&&!this.minimized()){var t=this.$elem;this._cache.sizes={self:this._getDimensions.call(t,{position:!0})},this._cache.sizes.diffs={width:t.outerWidth()-t.width(),height:t.outerHeight()-t.height()},this._refreshContainmentSize()}},_refreshContainmentSize:function(){this._cache.sizes.containment=this._getDimensions.call(this._getRealContainmentObject(),{position:!0}),this._refreshTaskbarMargins(),this._cache.sizes.containment.width-=this._cache.sizes.diffs.width,this._cache.sizes.containment.height-=this._cache.sizes.diffs.height},_refreshTaskbarMargins:function(){var t=this._getTaskbarInstance();t&&(this._cache.sizes.margins=t._getMaxTaskbarsMargins())},_getDimensions:function(e){var i=this,s=t.extend({},e&&e.position?i.position():i.offset(),{width:e&&e.outer?i.outerWidth():i.width(),height:e&&e.outer?i.outerHeight():i.height()});return s.bottom=s.height+s.top,s.right=s.width+s.left,s},_getButtonCoordinates:function(){var e=this.button(),i=this.$taskbar.hasClass(this.classes.taskbarHorizontal),s=this._getDimensions.call(e,{offset:!0});s.top-=t(window).scrollTop(),s.left-=t(window).scrollLeft(),s.opacity=0,s[i?"height":"width"]=0;var n=this.$taskbar.data(this._cnst.dataPrefix+"taskbarEdge");return"top"===n&&(s.top+=this.$taskbar.height()),"left"===n&&(s.left+=this.$taskbar.width()),this._deleteBottomRight(s),s},_refreshPosition:function(e){var i=this;if(e=e||{},!this._cache.minimized||this._cache.minimizing){var s=this._getRealContainment();if(e&&e.skipOnFit&&s===this._cache.refreshPositionContainment&&"viewport"!==s){var n=this._getTaskbarInstance();if(!n)return;var o=n._extendedPosition.call(n.$windowsContainment,"offset"),a=n._extendedPosition.call(this.$elem,"offset");if(a.right<=o.right&&a.bottom<=o.bottom&&a.top>=o.top&&a.left>=o.left)return}if(this._animationProgress())return void this._bindInternal("afterWindowAnimationStop",function(){i.refreshPosition()});this._cache.progress.refreshPosition=!0,this.$elem.stop(!0,!0),this._refreshContainmentSize(),this._setContainment();var r=this._cache.sizes.containment,l=this._cache.sizes.self;if(this.maximized()&&this.$elem.css(r),this.$windowOverlay&&this.$windowOverlay.length&&this._placeOverlay(this.$windowOverlay.hasClass(this.classes.contentOverlay)?{content:!0}:{window:!0}),this._cache.refreshPositionContainment=s,"visible"===this._cache.refreshPositionContainment)return this._setWidth(),this._setHeight(),this._moveIntoView(),this._setRestoreSize(),this._cache.progress.refreshPosition=!1,void this._refreshPositionOption();l.width=Math.min(l.width,r.width),l.height=Math.min(l.height,r.height);var h,c=!1,d=this.maximized(),u=this.minimized();return(d||u)&&(c=!0,this._cache.suppressEvents=!0,h=t.extend(!0,{},this.options.durations),this.options.durations=t.extend(!0,{},this._noAnimationDurations()),this.restore()),this._setRestoreSize(),l=this._fixPosition(l),l=this._roundObj(l),t.extend(this._cache.sizes.self,l),this.$elem.css(l),this._setWidth(),this._setHeight(),this._setRestoreSize(),d&&this.maximize(),u&&this.minimize(),c&&(this.options.durations=h,this._cache.suppressEvents=!1),this._moveIntoView(),this._fixTitlebarTitleWidth(),this._setContentHeight(),this._setRestoreSize(),this._refreshPositionOption(),this._cache.progress.refreshPosition=!1,this}},_bringIntoView:function(t){var e=(this.$title,this._getTaskbarInstance());if(e){var i=e._extendedPosition.call(this.$title,"offset"),s=e._extendedPosition.call(this._getRealContainmentObject(),"offset"),n=e._extendedPosition.call(this.$elem),o=this._bringIntoViewReserve(),a=(window.getComputedStyle(this.$title[0]),{}),r={};if(r.top=-1*(s.top-(i.bottom-o)),r.bottom=s.bottom-(i.top+o),r.left=-1*(s.left-(i.right-o)),r.right=s.right-(i.left+o),t&&t.round&&(r.top=Math.round(r.top),r.bottom=Math.round(r.bottom),r.left=Math.round(r.left),r.right=Math.round(r.right)),a.top=Math.min(r.top,0),a.bottom=Math.min(r.bottom,0),a.left=Math.min(r.left,0),a.right=Math.min(r.right,0),t&&t.diffs)return a;if(t&&t.move){var l={};l.top=n.top,l.left=n.left,l.top-=a.top,l.top+=a.bottom,l.left-=a.left,l.left+=a.right,l=this._roundObj(l),this.$elem.css(l)}}},_fixPosition:function(e){this._refreshContainmentSize();var i=this._getRealContainment(),s=this._cache.sizes.containment,e=e||t.extend({},this._cache.sizes.self),n=this;return this._deleteBottomRight(e),t.each([{edge:"top",dimension:"height"},{edge:"left",dimension:"width"}],function(t,o){if("viewport"===i&&(e[o.edge]!==(e[o.edge]=Math.max(e[o.edge],s[o.edge]))&&(e[o.dimension]=Math.min(e[o.dimension],s[o.dimension])),e[o.edge]+e[o.dimension]>s[o.edge]+s[o.dimension])){var a=e[o.edge]+e[o.dimension]-(s[o.edge]+s[o.dimension]);e[o.edge]>=a?e[o.edge]-=a:(e[o.edge]-=a,e[o.dimension]-=Math.abs(e[o.edge]),e[o.edge]=0)}{var r="min"+n._ucFirst(o.dimension);"max"+n._ucFirst(o.dimension)}n.options[r]>e[o.dimension]&&(e[o.dimension]=Math.min(n.options[r],s[o.dimension]))}),e},_deleteBottomRight:function(t){delete t.bottom,delete t.right},_bringIntoViewReserve:function(){return parseInt(this.uiDialogTitlebar.find("."+this.classes.uiDialogTitle).css("fontSize"),10)},_moveIntoView:function(){this._bringIntoView({move:!0})},_roundObj:function(e){return"object"==typeof e&&t.each(e,function(t,i){isNaN(parseInt(i),10)||(e[t]=Math.round(parseFloat(i)))}),e},_fullPxPosition:function(e){var i=this;t.each(e||["top","left","width","height"],function(t,e){i.$elem.css(e,Math.round(parseFloat(i.$elem.css(e))))})},_fixTitlebarTitleWidth:function(){var t=this.$elem.find("."+this.classes.uiDialogTitlebar+" ."+this.classes.uiButton+":last"),e=t.prev("."+this.classes.uiButton);if(t.length&&e.length){var i=this.$elem.find("."+this.classes.uiDialogTitle),s=e.offset().left-t.offset().left-t.outerWidth();i.css("width",t.offset().left-i.offset().left-s)}},_fixTitlebarTitleWidthDuringAnimation:function(){"number"==typeof arguments[1]&&(this._cache.animationProgress=arguments[1]),this._fixTitlebarTitleWidth()},_setWindowIcon:function(){var e=this.$elem.find("."+this.classes.icon);e.length&&null===this.options.icons.main&&e.remove(),this.uiDialogTitlebar.removeClass(this.classes.titlebarIcon);var i=this._getTaskbarInstance();if(i){var s=i.$elem.find("[data-window-id="+this.$window[0].id+"]");i._refreshWindowButtonIcon.call(s,i),null!==this.options.icons.main&&(this.uiDialogTitlebar.addClass(this.classes.titlebarIcon),e.length||(e=t("<span></span>").prependTo(this.uiDialogTitlebar)),e.removeAttr("class").addClass(this.classes.uiIcon+" "+this.classes.icon+" "+this.options.icons.main))}},_setContentHeight:function(){var t=this._getTaskbarInstance();if(t){this.$window.css({height:"auto",maxHeight:""});var e=t._extendedPosition.call(this.$elem,"offset"),i=t._extendedPosition.call(this.$window,"offset"),s=Math.round(e.bottom-i.top-parseFloat(this.$window.css("borderBottomWidth"))-parseFloat(this.$window.css("paddingTop"))-parseFloat(this.$window.css("paddingBottom")));this.uiDialogButtonPane.length&&this.uiDialogButtonPane.children().length&&(s-=this.uiDialogButtonPane.outerHeight()),this.$window.css("maxHeight",s)}},_createTitleForEmpty:function(){if(this._hasTaskbar()&&null===this.options.title){var t=this.$taskbar.data(this._cnst.dataPrefix+"taskbar").$windowsContainment,e=t.data(this._cnst.dataPrefix+"taskbarNewWindowsCount")||0,i="number"==typeof this._cache.newWindowNumber?this._cache.newWindowNumber:++e;this._cache.newWindowNumber=i,this._setNewWindowTitle(i),t.data(this._cnst.dataPrefix+"taskbarNewWindowsCount",e)}},_title:function(){if(this.options.titleLocalized)if(this._i18n(this.options.titleLocalized))this._setTitle(this._i18n(this.options.titleLocalized));else{this._setTitle(this._cache.title);var t=this._getTaskbarInstance();this._debugLogAdd('Missing translation for window title with key "'+this.options.titleLocalized+'" in language "'+t.options.language+'".',2,1)}else null!==this._cache.title&&this._setTitle(this._cache.title)},_setNewWindowTitle:function(t){this._setTitle(1===t?this._i18n("newWindow"):this._i18n("newWindowNext",{counter:t}))},_setTitle:function(t){if(arguments.length||(t=this._cache.realTitle),this._cache.realTitle=t,this.uiDialogTitlebar){var e=this.uiDialogTitlebar.find("."+this.classes.uiDialogTitle);this._cache.realTitle?e.text(this._cache.realTitle):e.html("&#160;")}this._setConnectedButtonTitle()},_setConnectedButtonTitle:function(){var t,e=this._cache.realTitle,i=this._getTaskbarInstance();if(i){try{t=this.$taskbar.taskbar("button",this.$window)}catch(s){return}if(t.attr("data-group-name")){var n=i.connectedElement(t).filter("."+this.classes.uiMenu).find('[data-window-id="'+this.$window[0].id+'"]');i._refreshWindowButtonIcon.call(n,i)}else i._buttonSetTitle.call(t,e,this._getTaskbarInstance())}},_cacheTitle:function(t){this._cache.title=t},_focusTabbable:function(){t(document.activeElement).blur(),this._super(),this._blurActiveElement()},_sortByZIndex:function(e,i,s){var n=[],o=this._cnst.lowestPossibleZIndex;if(e.each(function(){var e=parseInt(t(this).css("zIndex"),10)||++o;n.push([e,t(this)])}),n.sort(function(t,e){return"asc"===i?t[0]-e[0]:e[0]-t[0]}),"raw"===s)return n;var a=t();return t.each(n,function(t,e){a=a.add(e[1])}),a},_setModalZIndexes:function(){if(this.$elem.removeClass(this.classes.modal),this.options.modal){var e=this;this.$elem.addClass(this.classes.modal);var i=this.options.modalOverlay,s=this._cnst.lowestPossibleZIndex,n=t(),o=t(),a=t("."+this.classes.taskbar),r=t("."+this.classes.window);if("all"===i)n=n.add(a).add(r),o=t();else if("viewport"===i)n=n.add(r),o=o.add(a);else{if(!(i instanceof t))return;n=n.add(a).add(r).not(i),o=i}n=n.not(this.$elem).not("."+this.classes.modal+"."+this.classes.windowTop),o=o.not(this.$elem).not("."+this.classes.modal+"."+this.classes.windowTop);var l={};l.$setCover=n,l.$setNoCover=o,this._trigger("modalOverlaySetsCreated",{},l),n=l.$setCover,o=l.$setNoCover;var h=function(i){var n=t(this),o=parseInt(n.css("zIndex"),10);s=Math.max(o,s);var a=e._hasInlineProperty(n,"z-index"),r=i?e.classes.coveredByOverlay+e.uuid:e.classes.notCoveredByOverlay+e.uuid;n.hasClass(r)||n.data(e._cnst.dataPrefix+"previousZIndex"+e.uuid,o).data(e._cnst.dataPrefix+"inlineZIndex"+e.uuid,a).addClass(r)};if(n.length){n.each(function(){h.call(this,!0)}),n=this._sortByZIndex(n,"desc");var c=s;n.each(function(){t(this).css("zIndex",--c)})}this.$overlaySet=n,this.overlay||(this._createOverlay(),this._hideOverlay(!1)),s===this._cnst.lowestPossibleZIndex&&(s=parseInt(this.$elem.css("zIndex"),10)),this._cache.modalOverlayZIndex=++s,this.overlay.css("zIndex",this._cache.modalOverlayZIndex),o.length&&(o.each(function(){h.call(this,!1)}),o=this._sortByZIndex(o,"asc"),o.each(function(){t(this).css("zIndex",++s)})),this.$elem.css("zIndex",++s)}},_modalZIndexes:function(t){t&&t.revertActive===!1||this._revertActiveModalZIndexes(),this._revertModalZIndexes(),this._setModalZIndexes()},_revertModalZIndexes:function(e){if(this.options.modal){var i={};"object"==typeof e&&(i=e,e=!!i.force);var s=this,n=function(){var i=t(this);if(i.hasClass(s.classes.modal)&&i.hasClass(s.classes.windowTop)&&!e)return!0;var n=i.data(s._cnst.dataPrefix+"previousZIndex"+s.uuid),o=i.data(s._cnst.dataPrefix+"inlineZIndex"+s.uuid),a=o?n:"";i.removeData(s._cnst.dataPrefix+"previousZIndex"+s.uuid).removeData(s._cnst.dataPrefix+"inlineZIndex"+s.uuid).removeClass(s.classes.coveredByOverlay+s.uuid).removeClass(s.classes.notCoveredByOverlay+s.uuid).css("zIndex",a)};if(i.$elem)return void t(i.$elem).each(n);t("."+this.classes.coveredByOverlay+this.uuid).each(n),t("."+this.classes.notCoveredByOverlay+this.uuid).each(n)}},_revertActiveModalZIndexes:function(){var e=this._getAllModals(),i=this;e.length&&e.children("."+this.classes.windowContent).each(function(){var e=t(this),s=e.data(i._cnst.dataPrefix+"window");s._revertModalZIndexes({force:!0})})},_setTopModalState:function(t){var e=this._getActiveModal();this.options.modal&&(e=e.add(this.$elem)),e=e.filter("."+this.classes.windowTop),!e.length||t&&e.attr("id")===t.attr("id")||e.children("."+this.classes.windowContent).window("moveToTop",null,!0)},_getActiveModal:function(){return t("."+this.classes.modal).not("."+this.classes.windowMinimizing+":visible").not(this.$elem)},_getAllModals:function(){return t("."+this.classes.modal).not(this.$elem)},_minimizeOtherModals:function(e){if(this.options.modal){var i=this,s=this._getActiveModal();s.length&&s.each(function(){var s=t(this).children("."+i.classes.windowContent),n=s.window("option","durations.minimize");s.window("option","durations.minimize",!1).window("minimize",e).window("option","durations.minimize",n)})}},_isMinimizeAllInProgress:function(){return!!this._getTaskbarInstance().$windowsContainment.data(this._cnst.dataPrefix+"minimizeAllInProgress")},_hideTaskbarsSubordinates:function(){t("."+this.classes.taskbar).taskbar("hideSubordinates")},_createOverlay:function(){if(!this.overlay&&this.options.modal){this._super();var t=this;this._versionOf("dialog","==","1.10.0")&&this.overlay.appendTo(this._appendTo()),this.overlay.addClass(this.classes.dialogOverlay).css("zIndex",this._cache.modalOverlayZIndex).attr("data-taskbar-uuid",this._getTaskbarInstance().uuid).attr("data-window-uuid",this.uuid).on("click."+this._cache.uep+" dblclick."+this._cache.uep,function(i){t.options.minimizable&&t.minimize("dblclick"===i.type?!1:e)})}},_destroyOverlay:function(t){var e=t&&t.justDestroy;this.overlay&&(this.overlay.stop(!0,!0),this.options.modal&&!e&&this._revertModalZIndexes({force:!0}),this._super(),this.overlay&&this.overlay.length&&(this.overlay=null))},_showOverlay:function(){if(this.options.modal&&this.overlay){var t=this._getTaskbarInstance()._styleIndicator(this.classes.uiWidgetOverlay,"opacity").opacity;this.overlay.show().stop(!1,!0);var e={opacity:t},i={duration:this.options.durations.show};this._animate.call(this.overlay,e,i)}},_hideOverlay:function(t){if(this.options.modal){var e=this;if(this.overlay){this.overlay.stop(!0,!0);var i={opacity:0},s={duration:"undefined"!=typeof t?t:this.options.durations.minimize,always:function(){e.overlay&&e.overlay.hide()}};this._animate.call(this.overlay,i,s)}}},_placeOverlay:function(e){e=e||{},this.$elem.find("."+this.classes.windowOverlay+":not(."+this.classes.bodyOverlay+")").remove(),this.$elem.removeClass(this.classes.contentOverlayed),this.$windowOverlay=null,e&&"auto"===e.window&&(e.window=this.$elem.hasClass(this.classes.bodyOverlay));var i=this;if(e&&e.destroy)return void(e.window&&this.$elem.removeClass(this.classes.bodyOverlayed).find("."+this.classes.windowOverlay).remove());if(e.content=!(!this.options.embeddedContent&&!e.content||e&&e.window),!(this.$elem.hasClass(this.classes.windowTop)&&e.content||(this._blurActiveElement(),!e.content&&e.destroy))){if(e.content||e.window){if(this.$elem.find("."+this.classes.bodyOverlay).length&&(!e||!e.window))return;this.$windowOverlay=t("<div></div>").addClass(this.classes.windowOverlay+" "+this.classes.uiWidgetOverlay).addClass(e.content?this.classes.contentOverlay:this.classes.bodyOverlay),this.$elem.find("."+this.classes.windowOverlay).remove(),this.$elem.prepend(this.$windowOverlay),this.$elem.addClass(e.content?this.classes.contentOverlayed:this.classes.bodyOverlayed)}e.content&&this.$windowOverlay.on("mousedown."+this._cache.uep,function(t){i._clearTrigger(t)}),e.window&&this.$windowOverlay.off("mousedown."+this._cache.uep).on("mousedown."+this._cache.uep,function(){i._cache.progress.close&&i.$confirmCloseWindow.length&&i.$confirmCloseWindow.window("show")})}},_preventGlobalWindowClick:function(){var t=this._getTaskbarInstance();if(t){var e=t.$windowsContainment.data(this._cnst.dataPrefix+"taskbars")||0,i=t.$windowsContainment.data(this._cnst.dataPrefix+"preventClicks")||0;this._cache.taskbarsOnClickPrevention=e,t.$windowsContainment.data(this._cnst.dataPrefix+"preventClicks",e+i)}},_revertGlobalWindowClick:function(){var t=this._getTaskbarInstance();if(t){var e=t.$windowsContainment.data(this._cnst.dataPrefix+"preventClicks"),i=this._cache.taskbarsOnClickPrevention,s=Math.max(e-i,0);t.$windowsContainment.data(this._cnst.dataPrefix+"preventClicks",s)}},_createButtons:function(){this._super();var e=this;if(this.uiDialog.hasClass(this.classes.uiDialogButtons)){var i=0;t.each(this.options.buttons,function(s,n){var o;n.textLocalized&&(o=e._i18n(n.textLocalized),"undefined"!==o&&t("."+e.classes.uiButton+":eq("+i+")",e.uiDialogButtonPane).button({label:o})),n.textLocalized&&"undefined"!==o||n.text||isNaN(parseInt(s))||e._debugLogAdd('No text or textLocalized providen for button "'+s+'".',2,1),++i})}},_setMinimizableMaximizableClasses:function(){this.$elem.toggleClass(this.classes.unminimizable,this.options.minimizable===!1),this.$elem.toggleClass(this.classes.unmaximizable,this.options.maximizable===!1)},_languageChange:function(){this._createTitleForEmpty(),this._title(),this._propagateConfirmCloseOptions({confirmClose:{},title:null}),this._setButtonsTexts(),this._createButtons()},_size:function(){this._versionOf("dialog","==","1.10.0")&&(this._isOpen=!0),this._super()},_debugLogAdd:function(t,e,i){var s=this._getTaskbarInstance();s&&(s._consolePrefix(this.$window[0].id,"window"),s._debugLogAdd(t,e,i),s._consolePrefix(!0))},_hasInlineProperty:function(t,e){var i=t.prop("style");for(var s in i)if(i.hasOwnProperty(s)&&i[s]===e)return!0;return!1},_clearTrigger:function(e){var i=this._getTaskbarInstance();i&&t(window).trigger("click."+i._cache.uep,e)},_blurActiveElement:function(e){var i=this.document[0].activeElement,s=this.bindings[0];(e&&(t.contains(s,i)||i===s)||!e&&i===this.uiDialogTitlebarClose[0])&&t(i).blur()},_ucFirst:function(t){return t[0].toUpperCase()+t.slice(1)},_versionOf:function(e,i,s){return t.simone.taskbar.prototype._versionOf.call(null,e,i,s)},_parseDuration:function(i){return"number"==typeof i?i:i in t.fx.speeds?t.fx.speeds[i]:e},_trigger:function(e,i,s){return"open"===e||"create"===e&&!this._cache.initialized?void 0:(t.extend(s,{instance:this,$widget:this.$elem,$window:this.$window}),"taskbarNotFound"!==e&&t.extend(s,{taskbar:this._getTaskbarInstance(),$taskbar:this.$taskbar}),this._super(e,i,s))},button:function(){var e=this._getTaskbarInstance();return e?e.button(this.$window):t()},close:function(t){this._close(t)},confirmCloseWindow:function(){return this.$confirmCloseWindow},containment:function(){return this._getRealContainment()},maximize:function(t){this._toggleMaximized(!0,t)},maximized:function(){return this._cache.maximized&&!this._cache.maximizing},maximizing:function(){return this._cache.maximizing},minimize:function(t){this._minimize(t)},minimized:function(){return this._cache.minimized&&!this._cache.minimizing},minimizing:function(){return this._cache.minimizing},modalOverlay:function(){return this.overlay||t()},moveToTop:function(t,e){this._moveToTop(t,e)},open:function(t){this._cache.initialized?(this._debugLogAdd('Method "open" is an alias for method "show". Use method "show" instead.',2,2),this.show(t)):this._super()},refreshPosition:function(t){this._refreshPosition(t)},restore:function(t){this._toggleMaximized(!1,t)},restored:function(){return this.shown()&&!this.maximized()},restoring:function(){return this._cache.restoring},shown:function(){return this.$elem.is(":visible")&&!this._animationProgress()},showing:function(){return this._cache.showing},taskbar:function(){return this.$taskbar},title:function(){return this._cache.realTitle},_checkForInvalidOptions:function(t,e,i){var s=this._getTaskbarInstance();s&&(s._consolePrefix(this.$window[0].id,"window"),s._checkForInvalidOptions(t,e,i),s._consolePrefix(!0))},_setOptions:function(e){var i=this,s=(this.options,!1),n=!1,o={};t.each(e,function(e,a){i._setOption(e,a),e in i.sizeRelatedOptions&&(-1===t.inArray(e,i._cnst.dimensions)?s=!0:i.options[e]=a=Math.max(a,i.options["min"+i._ucFirst(e)]),n=!0),e in i.resizableRelatedOptions&&(o[e]=a)}),s&&(this._size(),this._position()),this.uiDialog.is(":data(ui-resizable)")&&this.uiDialog.resizable("option",o),n&&(this._setWidth(),this._setHeight(),this.refreshPosition())},_setOption:function(e,i){var s=t.extend(!0,{},this.options[e]);this._checkForInvalidOptions(t.simone.window.prototype.options,e),"title"===e?this._cacheTitle(i):"taskbar"===e?this._taskbarUnbind():("modal"===e||"modalOverlay"===e)&&(this._revertModalZIndexes({force:!0}),this._destroyOverlay()),"widgetClass"===e&&this.uiDialog.removeClass(this.options.widgetClass).addClass(i),"closeText"!==e&&"position"!==e?this._superApply(arguments):this.options[e]=i,this._debugOptions(),("minimizable"===e||"maximizable"===e)&&this._setMinimizableMaximizableClasses(),"maximizable"===e?this._createButton("maximize"):"minimizable"===e?this._createButton("minimize"):"icons"===e?(this._setWindowIcon(),this._refreshButtonIcons(),this._propagateConfirmCloseOptions(e,s)):"titleLocalized"===e||"title"===e?(this._createTitleForEmpty(),this._title(),this._propagateConfirmCloseOptions(e,s)):"maximized"===e?this._toggleMaximized(i):"containment"===e?(this._setContainment(),this.refreshPosition()):"position"===e?(this._position(),this._setRestoreSize(),this.refreshPosition()):"width"===e||"maxWidth"===e?(this._setWidth(),this.refreshPosition()):"height"===e||"maxHeight"===e?(this._setHeight(),this.refreshPosition()):"modal"===e||"modalOverlay"===e?(this._createOverlay(),this._modalZIndexes({revertActive:!1})):"closable"===e?this._setButtonCloseState():"buttons"===e?this.refreshPosition():"taskbar"===e?(this._rebindTaskbar(),this._propagateConfirmCloseOptions(e,s)):"confirmClose"===e||"durations"===e?this._propagateConfirmCloseOptions(e,s):"embeddedContent"===e?this._placeOverlay():"group"===e?this._refreshGroup():t.inArray(e,this._unsupportedOptions)>-1?(this._debugUnsupportedOptions(),this._resetUnsupportedOptions()):"appendTo"===e&&this.overlay&&this.overlay.prependTo(this._appendTo())},destroy:function(){if(this._onInteractionEnd("destroy")===!0)return this;if(!this._cache.destroyed){if(!this._cache.closeInevitable&&this._cache.initialized)return this._cache.closeForced=!0,void this.close();var e=this;this._cache.destroyed=!0,this._clearTimeouts(),this._preventGlobalWindowClick(),this.$elem.removeClass(this.classes.modal),this._moveToTop({highest:!0}),this.$window.removeUniqueId().removeClass(this.classes.windowContent+" "+this.classes.confirmClose).removeData(this._cnst.dataPrefix+"window"),this.$elem.stop(!0,!0).removeClass(this.classes.window),this._super(),this.$window.attr("style",this._cache.inlineCSS),t.each(["class","style"],function(t,i){""===e.$window.attr(i)&&e.$window.removeAttr(i)})}}}),t.simone.windowSetup=function(e,i){i=1===arguments.length?e:i,e===!0&&arguments.length>1&&t("."+t.simone.window.prototype.classes.windowContent).window("option",i);var s=t.simone.window.prototype.options;return i?t.extend(!0,s,i):s}}(jQuery);